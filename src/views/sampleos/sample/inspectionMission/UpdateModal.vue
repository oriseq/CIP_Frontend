...
<script lang="ts" setup>
  ...
  import { RunCheckTreeBox, getUserGroupInfoApi } from '../inspectionForm/inspectionFormApi';
      ...
      },
      {
        ...
        componentProps: {
          ...
          onChange: (args, obj) => {
            ...
            // 首次点击，args可能存在值，obj为undefined，非内部组因不可填写，args一直为null
            if (args != null && args == obj?.value) {
              warning('送检单位已被修改，样本编号和当天提交编号可能不统一，请根据需要手动修改');
            }
          },
        },
        ifShow: userStore.userInfo?.isInternalGroup,
